<template>
  <div>
    ...
    <van-cell-group>
      ...
      />
      <div style="font-size:14px;color:#585858;padding:14px"><span>更改密码：</span><van-button style="border-radius:4px 4px 4px 4px;padding-left:4px;padding-right:4px" color="#5ca3ff" size="mini" type="info">更改手机号</van-button></div>
