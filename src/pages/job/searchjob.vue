<template>
  <div style="height:100%">
    ...
    />
  <div style="background-image: linear-gradient(#5ca3ff, #ebf1fd);padding-bottom: 20px;margin-top: -20px;padding-top: 20px;">
  ...
  mounted() {
    window.addEventListener('scroll', () => {
      ...
      if(scrollTop + window.innerHeight >= document.body.offsetHeight) {
        ...
        doGet(`${API_HOST}/api/job/job/getJobByPage`,{pageNum:++this.page,pageSize:10,jobname:this.$route.query.name}).then(res => {
